...
(function () {
    ...
    async function loadMarketplaceData() {
        ...
        try {
            ...
            if (!data || data.length === 0) {
                container.innerHTML = '<p style="padding: 20px; text-align: center; color: var(--text-tertiary);">No marketplace prompts yet</p>';
                return;
            }
            ...
            data.forEach(prompt => {
                html += `
                    <tr>
                        ...
                        <td><span class="badge badge-${prompt.tier}">${prompt.tier.toUpperCase()}</span></td>
                    </tr>
                `;
            });
            ...
            container.innerHTML = '<p style="padding: 20px; text-align: center; color: var(--danger);">Error loading marketplace data</p>';
        }
    }
